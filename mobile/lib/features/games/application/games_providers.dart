...
final gamesApiProvider = Provider<GamesApi>(
  (ref) => GamesApi(ref.watch(apiClientProvider)),
);
...
final gameServersProvider = FutureProvider.family<List<GameServer>, String>((
  ref,
  gameId,
) {
...
final gameProductsProvider =
    FutureProvider.family<List<Product>, GameProductsQuery>((ref, query) {
      return ref
          .watch(gamesApiProvider)
          .listGameProducts(query.gameId, serverCode: query.serverCode);
    });
