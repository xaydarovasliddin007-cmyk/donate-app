...
/// Step 2 of password reset: confirm the emailed code and choose a new
/// password. Completing this logs the account straight into this device —
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    l10n.authForgotPasswordSentMessage(widget.email),
                    textAlign: TextAlign.center,
