...
describe('POST /api/v1/auth/google', () => {
  ...
  // This dev environment has no GOOGLE_CLIENT_ID configured (see .env.example
  // / README "Google Sign-In setup") — verifyGoogleIdToken() must refuse
  // before ever reaching Prisma, so this is safely testable without a DB.
